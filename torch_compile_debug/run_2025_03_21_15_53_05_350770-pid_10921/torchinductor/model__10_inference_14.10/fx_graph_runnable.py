...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1):
        div = torch.ops.aten.div.Tensor(arg1_1, arg0_1)
        sub = torch.ops.aten.sub.Tensor(1, div);  div = None
        sub_1 = torch.ops.aten.sub.Tensor(1, arg0_1);  arg0_1 = None
        sub_2 = torch.ops.aten.sub.Tensor(1, arg1_1);  arg1_1 = None
        div_1 = torch.ops.aten.div.Tensor(sub_1, sub_2);  sub_1 = sub_2 = None
        mul = torch.ops.aten.mul.Tensor(div_1, sub);  div_1 = sub = None
        clamp_min = torch.ops.aten.clamp_min.default(mul, 1e-20);  mul = None
        return (clamp_min,)
...
def load_args(reader):
    ...
    reader.tensor(buf1, (), storage_offset=999, is_leaf=True)  # arg1_1
