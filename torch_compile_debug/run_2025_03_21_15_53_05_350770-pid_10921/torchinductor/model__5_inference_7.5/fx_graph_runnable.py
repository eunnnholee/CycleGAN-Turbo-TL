...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1):
        ge = torch.ops.aten.ge.Scalar(arg1_1, 0);  arg1_1 = None
        return (arg0_1, ge)
        
def load_args(reader):
    buf0 = reader.storage(None, 4000, device=device(type='cuda', index=0))
    reader.tensor(buf0, (), storage_offset=999, is_leaf=True)  # arg0_1
    buf1 = reader.storage(None, 8, dtype_hint=torch.int64)
