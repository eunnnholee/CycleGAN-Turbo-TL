...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_1, primals_2, primals_3):
        pow_1 = torch.ops.aten.pow.Tensor_Scalar(primals_1, 0.5);  primals_1 = None
        mul = torch.ops.aten.mul.Tensor(pow_1, primals_2);  pow_1 = primals_2 = None
        add = torch.ops.aten.add.Tensor(primals_3, mul);  primals_3 = mul = None
        return (add,)
