...
# kernel path: /tmp/torchinductor_elicer/w2/cw2qgijaidn7vnsjazo54bjhd532jpfwbsfkv4qs4pjwdj22tjbf.py
...
# kernel path: /tmp/torchinductor_elicer/tz/ctzmqzzz5drsdjceye4vi6obx7p7ooyanfae7vdtjdaa6lqhw6zd.py
...
# kernel path: /tmp/torchinductor_elicer/c3/cc3rrvgcxvulgqi6ztmwqnihtsaiiy2jqbd2i4yxtmhp5ea3eo4y.py
...
# kernel path: /tmp/torchinductor_elicer/sn/csnyaowglgpg7i5pu6e4svykjcfovdjohydnsb5tvlfntvamy7mj.py
...
# kernel path: /tmp/torchinductor_elicer/it/citxia2up4heqxvql7iec5lvqfn7ttqyp4zmrudwayzclzvdlplk.py
...
# kernel path: /tmp/torchinductor_elicer/wr/cwrl2lg5jbinbjdc6je7yv3ume5c45ienvdlksimzh2low2kqx64.py
...
# kernel path: /tmp/torchinductor_elicer/lf/clf7yt37bzksq56fq4qoz4lrls7yq2v6z3skp2kqchnzaak6u3re.py
...
# kernel path: /tmp/torchinductor_elicer/3q/c3qeicq52bbx7aivz776k2ukmindzzhewq7bx2xdxb7eoobjyf63.py
...
# kernel path: /tmp/torchinductor_elicer/fa/cfacjkr4coejm2ts5waqw7sztef6xmpn2jdav4eatxle2ydaj4cd.py
# Topologically Sorted Source Nodes: [mean_1], Original ATen: [aten.mean]
# Source node to ATen node mapping:
#   mean_1 => mean_1
# Graph fragment:
...
# kernel path: /tmp/torchinductor_elicer/dx/cdxfwoi44a5h46s6ukzandmgagrby273txnfupi4kswuvkdrehgp.py
...
# kernel path: /tmp/torchinductor_elicer/6y/c6yiawwg6fmi2qqg2xiodyqdnbc2a2qvm6vpnfket4xavmapvlzq.py
# Topologically Sorted Source Nodes: [mean], Original ATen: [aten.mean]
# Source node to ATen node mapping:
#   mean => mean
# Graph fragment:
...
# kernel path: /tmp/torchinductor_elicer/gp/cgpytfj232yfwukpe3mpsemmhlmpm3xr34tbpnsghuvu2ind72zo.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
# kernel path: /tmp/torchinductor_elicer/yn/cynu3r3byidm34gixynnvuzn7mssexm35qgpiue3uqfkrvtnjpuz.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
# kernel path: /tmp/torchinductor_elicer/xn/cxnmohujwkfpqwwvfkunfmrxhvvbzlmuf2ndc6tdnbsjkrdaudcq.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
# kernel path: /tmp/torchinductor_elicer/ux/cuxkah7re7unbm3t5hwmxl77smuksaoebw4zimunt7ogcz3esyi3.py
# Unsorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'ynumel': 'i32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=42, cc=80, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, warp_size=32), 'constants': {}, 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_18', 'mutated_arg_names': [], 'optimize_mem': False, 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'D805D6112358B1404BAFE009681C8B83D24CEB9D69C06D6B675EC44CAB42D254', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/torchinductor_elicer/pl/cpl34o2omredrkfhpd3fxtlznavfrjaci4fwrzjmyy3bzs47etqb.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*i8', 'xnumel': 'i32'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=42, cc=80, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, warp_size=32), 'constants': {}, 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2, 3), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_max_pool2d_with_indices_19', 'mutated_arg_names': [], 'optimize_mem': False, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': 'D805D6112358B1404BAFE009681C8B83D24CEB9D69C06D6B675EC44CAB42D254', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/torchinductor_elicer/kc/ckcjmpidgwx4lgnfo4rcpjbw52aiw4ajhfjepywk3sxi4n5vh5pt.py
...
# kernel path: /tmp/torchinductor_elicer/3w/c3wcc4qqozp74mvsjy4qqdcx4pnqeff2c727niksx4ehhiogconf.py
...
@triton.jit
def triton_poi_fused_convolution_div_max_pool2d_with_indices_relu_sub_21(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    xnumel = 2097152
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:]
    xmask = tl.full([XBLOCK], True, tl.int1)
...
# kernel path: /tmp/torchinductor_elicer/nk/cnk3jjalq2pqcy2sy7fczai2in5kxm7unrkpd4ujdb2jgxmw3fzy.py
...
triton_per_fused_add_convolution_div_max_pool2d_with_indices_mul_pow_relu_sqrt_sub_sum_22 = async_compile.triton('triton_per_fused_add_convolution_div_max_pool2d_with_indices_mul_pow_relu_sqrt_sub_sum_22', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_out_ptr1': '*fp32', 'in_out_ptr2': '*fp32', 'in_ptr0': '*fp32', 'out_ptr1': '*fp32', 'out_ptr2': '*fp32', 'out_ptr3': '*fp32', 'xnumel': 'i32', 'rnumel': 'i32'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=42, cc=80, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, warp_size=32), 'constants': {}, 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2, 3, 4, 5, 6, 7, 8), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_convolution_div_max_pool2d_with_indices_mul_pow_relu_sqrt_sub_sum_22', 'mutated_arg_names': ['in_out_ptr0', 'in_out_ptr1', 'in_out_ptr2'], 'optimize_mem': False, 'no_x_dim': True, 'num_load': 3, 'num_reduction': 2, 'backend_hash': 'D805D6112358B1404BAFE009681C8B83D24CEB9D69C06D6B675EC44CAB42D254', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_per_fused_add_convolution_div_max_pool2d_with_indices_mul_pow_relu_sqrt_sub_sum_22(in_out_ptr0, in_out_ptr1, in_out_ptr2, in_ptr0, out_ptr1, out_ptr2, out_ptr3, xnumel, rnumel):
    xnumel = 16384
...
# kernel path: /tmp/torchinductor_elicer/dg/cdgn5jnph4lih7wlcwhymcnpgqp5meepptnzhqssy37abv7kjclv.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*i8', 'xnumel': 'i32'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=42, cc=80, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, warp_size=32), 'constants': {}, 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2, 3), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_max_pool2d_with_indices_23', 'mutated_arg_names': [], 'optimize_mem': False, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': 'D805D6112358B1404BAFE009681C8B83D24CEB9D69C06D6B675EC44CAB42D254', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/torchinductor_elicer/bh/cbhojx5vk4rj6itzj3iacry3kd5o4dg3ecckkzjrzehbhag54d4l.py
...
# kernel path: /tmp/torchinductor_elicer/rv/crvp6apm7c45xsmm2eloon5ere3ehqs3xostofuops4crm36qfqk.py
...
# kernel path: /tmp/torchinductor_elicer/lq/clqrfjvewajling4bbihshgjmi25vf5ui5sffj6hsrrx327ohrvk.py
...
# kernel path: /tmp/torchinductor_elicer/cz/cczjyhplexyuf5p22rlbbot7k3h56m6vpunowt7ezhbjqmfxeydy.py
...
# kernel path: /tmp/torchinductor_elicer/mk/cmkavgiw4e3xpawgyvc2pmrahqd3raaay2dfbdyutikalfenwuvp.py
...
# kernel path: /tmp/torchinductor_elicer/kt/cktxdnlpcyogt2es2yge2v5oo5w6ca3kyh747nlznvai6zfjpk6c.py
...
# kernel path: /tmp/torchinductor_elicer/rp/crphmtoyatgvz4xr6yumlrlaw4eybqxz7gyl3qlm5asprihzlljn.py
...
# kernel path: /tmp/torchinductor_elicer/bk/cbky7ihcbngk5t7bwrgsd3qgfxh5c7pskodxoar77fepnypawcsz.py
...
# kernel path: /tmp/torchinductor_elicer/mg/cmgtviapa6fs64xgfc4vfjf27qdjqmqxr3haky4ltw5ydxoi45xd.py
...
# kernel path: /tmp/torchinductor_elicer/2l/c2lwcwek7bn6fll7553fj4o2zucljbi6oplnmsx2noal7bb4iltf.py
...
def call(args):
    ...
    assert_size_stride(primals_4, (4, 3, 256, 256), (196608, 65536, 256, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del primals_5
        buf13 = empty_strided_cuda((4, 3, 256, 256), (196608, 1, 768, 3), torch.float32)
        buf48 = empty_strided_cuda((4, 3, 256, 256), (196608, 1, 768, 3), torch.float32)
        # Topologically Sorted Source Nodes: [sub, in0_input, sub_1, in1_input], Original ATen: [aten.sub, aten.div]
        stream0 = get_raw_stream(0)
        triton_poi_fused_div_sub_4.run(primals_2, primals_1, primals_3, primals_4, buf13, buf48, 12, 65536, grid=grid(12, 65536), stream=stream0)
        del primals_1
        del primals_2
        del primals_4
        ...
        assert_size_stride(buf14, (4, 64, 256, 256), (4194304, 1, 16384, 64))
        buf15 = buf14; del buf14  # reuse
        # Topologically Sorted Source Nodes: [input_1, input_2], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_5.run(buf15, primals_6, 16777216, grid=grid(16777216), stream=stream0)
        ...
        assert_size_stride(buf16, (4, 64, 256, 256), (4194304, 1, 16384, 64))
        ...
        assert_size_stride(buf49, (4, 64, 256, 256), (4194304, 1, 16384, 64))
        del buf48
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_5.run(buf50, primals_6, 16777216, grid=grid(16777216), stream=stream0)
        del primals_6
        ...
        assert_size_stride(buf51, (4, 64, 256, 256), (4194304, 1, 16384, 64))
        buf17 = buf16; del buf16  # reuse
        buf79 = empty_strided_cuda((4, 1, 256, 256), (65536, 262144, 256, 1), torch.float32)
        buf80 = reinterpret_tensor(buf79, (4, 1, 256, 256), (65536, 1, 256, 1), 0); del buf79  # reuse
        buf52 = buf51; del buf51  # reuse
        buf82 = buf50; del buf50  # reuse
        buf119 = empty_strided_cuda((4, 64, 256, 256), (4194304, 1, 16384, 64), torch.float32)
        buf120 = empty_strided_cuda((4, 64, 256, 256), (4194304, 1, 16384, 64), torch.float32)
        # Topologically Sorted Source Nodes: [sub_1, in1_input, input_3, input_4, input_31, input_32, input_33, input_34, pow_1, sum_1, norm_factor, add, truediv_2, pow_2, sum_2, norm_factor_1, add_1, truediv_3, sub_2, pow_3], Original ATen: [aten.sub, aten.div, aten.convolution, aten.relu, aten.pow, aten.sum, aten.sqrt, aten.add, aten.mul]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_convolution_div_mul_pow_relu_sqrt_sub_sum_6.run(buf17, buf80, buf52, primals_8, buf82, buf119, buf120, 262144, 64, grid=grid(262144), stream=stream0)
        del primals_8
        buf18 = empty_strided_cuda((4, 64, 128, 128), (1048576, 1, 8192, 64), torch.float32)
        buf19 = empty_strided_cuda((4, 64, 128, 128), (1048576, 1, 8192, 64), torch.int8)
        # Topologically Sorted Source Nodes: [input_5], Original ATen: [aten.max_pool2d_with_indices]
        stream0 = get_raw_stream(0)
        triton_poi_fused_max_pool2d_with_indices_7.run(buf17, buf18, buf19, 4194304, grid=grid(4194304), stream=stream0)
        ...
        assert_size_stride(buf20, (4, 128, 128, 128), (2097152, 1, 16384, 128))
        buf21 = buf20; del buf20  # reuse
        # Topologically Sorted Source Nodes: [input_6, input_7], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_8.run(buf21, primals_10, 8388608, grid=grid(8388608), stream=stream0)
        ...
        assert_size_stride(buf22, (4, 128, 128, 128), (2097152, 1, 16384, 128))
        buf53 = empty_strided_cuda((4, 64, 128, 128), (1048576, 1, 8192, 64), torch.float32)
        # Topologically Sorted Source Nodes: [sub_1, in1_input, input_31, input_32, input_33, input_34, input_35], Original ATen: [aten.sub, aten.div, aten.convolution, aten.relu, aten.max_pool2d_with_indices]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_div_max_pool2d_with_indices_relu_sub_9.run(buf52, buf53, 4194304, grid=grid(4194304), stream=stream0)
        del buf52
        ...
        assert_size_stride(buf54, (4, 128, 128, 128), (2097152, 1, 16384, 128))
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_8.run(buf55, primals_10, 8388608, grid=grid(8388608), stream=stream0)
        del primals_10
        ...
        assert_size_stride(buf56, (4, 128, 128, 128), (2097152, 1, 16384, 128))
        buf23 = buf22; del buf22  # reuse
        buf83 = empty_strided_cuda((4, 1, 128, 128), (16384, 65536, 128, 1), torch.float32)
        buf84 = reinterpret_tensor(buf83, (4, 1, 128, 128), (16384, 1, 128, 1), 0); del buf83  # reuse
        buf57 = buf56; del buf56  # reuse
        buf86 = buf55; del buf55  # reuse
        buf117 = empty_strided_cuda((4, 128, 128, 128), (2097152, 1, 16384, 128), torch.float32)
        buf118 = empty_strided_cuda((4, 128, 128, 128), (2097152, 1, 16384, 128), torch.float32)
        # Topologically Sorted Source Nodes: [sub_1, in1_input, input_8, input_9, input_31, input_32, input_33, input_34, input_35, input_36, input_37, input_38, input_39, pow_4, sum_3, norm_factor_2, add_2, truediv_4, pow_5, sum_4, norm_factor_3, add_3, truediv_5, sub_3, pow_6], Original ATen: [aten.sub, aten.div, aten.convolution, aten.relu, aten.max_pool2d_with_indices, aten.pow, aten.sum, aten.sqrt, aten.add, aten.mul]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_convolution_div_max_pool2d_with_indices_mul_pow_relu_sqrt_sub_sum_10.run(buf23, buf84, buf57, primals_12, buf86, buf117, buf118, 65536, 128, grid=grid(65536), stream=stream0)
        del primals_12
        ...
        assert_size_stride(buf103, (4, 1, 128, 128), (16384, 1, 128, 1))
        buf104 = empty_strided_cuda((4, 1, 1, 1, 2), (2, 8, 8, 8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [mean_1], Original ATen: [aten.mean]
        stream0 = get_raw_stream(0)
        triton_red_fused_mean_11.run(buf103, buf104, 8, 8192, grid=grid(8), stream=stream0)
        del buf103
        buf105 = empty_strided_cuda((4, 1, 1, 1), (1, 4, 4, 4), torch.float32)
        # Topologically Sorted Source Nodes: [mean_1], Original ATen: [aten.mean]
        stream0 = get_raw_stream(0)
        triton_per_fused_mean_12.run(buf104, buf105, 4, 2, grid=grid(4), stream=stream0)
        del buf104
        ...
        assert_size_stride(buf100, (4, 1, 256, 256), (65536, 1, 256, 1))
        buf101 = empty_strided_cuda((4, 1, 1, 1, 8), (8, 32, 32, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [mean], Original ATen: [aten.mean]
        stream0 = get_raw_stream(0)
        triton_red_fused_mean_13.run(buf100, buf101, 32, 8192, grid=grid(32), stream=stream0)
        del buf100
        buf102 = empty_strided_cuda((4, 1, 1, 1), (1, 4, 4, 4), torch.float32)
        # Topologically Sorted Source Nodes: [mean], Original ATen: [aten.mean]
        stream0 = get_raw_stream(0)
        triton_per_fused_mean_14.run(buf101, buf102, 4, 8, grid=grid(4), stream=stream0)
        del buf101
        buf9 = empty_strided_cuda((512, 512, 3, 3), (4608, 1, 1536, 512), torch.float32)
        # Unsorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_poi_fused_15.run(primals_23, buf9, 262144, 9, grid=grid(262144, 9), stream=stream0)
        del primals_23
        buf8 = empty_strided_cuda((512, 512, 3, 3), (4608, 1, 1536, 512), torch.float32)
        # Unsorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_poi_fused_15.run(primals_21, buf8, 262144, 9, grid=grid(262144, 9), stream=stream0)
        del primals_21
        buf7 = empty_strided_cuda((512, 256, 3, 3), (2304, 1, 768, 256), torch.float32)
        # Unsorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_poi_fused_16.run(primals_19, buf7, 131072, 9, grid=grid(131072, 9), stream=stream0)
        del primals_19
        buf6 = empty_strided_cuda((256, 256, 3, 3), (2304, 1, 768, 256), torch.float32)
        # Unsorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_poi_fused_17.run(primals_17, buf6, 65536, 9, grid=grid(65536, 9), stream=stream0)
        del primals_17
        buf5 = empty_strided_cuda((256, 256, 3, 3), (2304, 1, 768, 256), torch.float32)
        # Unsorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_poi_fused_17.run(primals_15, buf5, 65536, 9, grid=grid(65536, 9), stream=stream0)
        del primals_15
        buf4 = empty_strided_cuda((256, 128, 3, 3), (1152, 1, 384, 128), torch.float32)
        # Unsorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_poi_fused_18.run(primals_13, buf4, 32768, 9, grid=grid(32768, 9), stream=stream0)
        del primals_13
        buf24 = empty_strided_cuda((4, 128, 64, 64), (524288, 1, 8192, 128), torch.float32)
        buf25 = empty_strided_cuda((4, 128, 64, 64), (524288, 1, 8192, 128), torch.int8)
        # Topologically Sorted Source Nodes: [input_10], Original ATen: [aten.max_pool2d_with_indices]
        stream0 = get_raw_stream(0)
        triton_poi_fused_max_pool2d_with_indices_19.run(buf23, buf24, buf25, 2097152, grid=grid(2097152), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [input_11, input_12], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_20.run(buf27, primals_14, 4194304, grid=grid(4194304), stream=stream0)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_20.run(buf29, primals_16, 4194304, grid=grid(4194304), stream=stream0)
        ...
        assert_size_stride(buf30, (4, 256, 64, 64), (1048576, 1, 16384, 256))
        buf58 = empty_strided_cuda((4, 128, 64, 64), (524288, 1, 8192, 128), torch.float32)
        # Topologically Sorted Source Nodes: [sub_1, in1_input, input_31, input_32, input_33, input_34, input_35, input_36, input_37, input_38, input_39, input_40], Original ATen: [aten.sub, aten.div, aten.convolution, aten.relu, aten.max_pool2d_with_indices]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_div_max_pool2d_with_indices_relu_sub_21.run(buf57, buf58, 2097152, grid=grid(2097152), stream=stream0)
        del buf57
        ...
        assert_size_stride(buf59, (4, 256, 64, 64), (1048576, 1, 16384, 256))
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_20.run(buf60, primals_14, 4194304, grid=grid(4194304), stream=stream0)
        del primals_14
        ...
        assert_size_stride(buf61, (4, 256, 64, 64), (1048576, 1, 16384, 256))
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_20.run(buf62, primals_16, 4194304, grid=grid(4194304), stream=stream0)
        del primals_16
        ...
        assert_size_stride(buf63, (4, 256, 64, 64), (1048576, 1, 16384, 256))
        buf31 = buf30; del buf30  # reuse
        buf87 = empty_strided_cuda((4, 1, 64, 64), (4096, 16384, 64, 1), torch.float32)
        buf88 = reinterpret_tensor(buf87, (4, 1, 64, 64), (4096, 1, 64, 1), 0); del buf87  # reuse
        buf64 = buf63; del buf63  # reuse
        buf90 = buf62; del buf62  # reuse
        buf115 = buf60; del buf60  # reuse
        buf116 = reinterpret_tensor(buf53, (4, 256, 64, 64), (1048576, 1, 16384, 256), 0); del buf53  # reuse
        # Topologically Sorted Source Nodes: [sub_1, in1_input, input_15, input_16, input_31, input_32, input_33, input_34, input_35, input_36, input_37, input_38, input_39, input_40, input_41, input_42, input_43, input_44, input_45, input_46, pow_7, sum_5, norm_factor_4, add_4, truediv_6, pow_8, sum_6, norm_factor_5, add_5, truediv_7, sub_4, pow_9], Original ATen: [aten.sub, aten.div, aten.convolution, aten.relu, aten.max_pool2d_with_indices, aten.pow, aten.sum, aten.sqrt, aten.add, aten.mul]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_convolution_div_max_pool2d_with_indices_mul_pow_relu_sqrt_sub_sum_22.run(buf31, buf88, buf64, primals_18, buf90, buf115, buf116, 16384, 256, grid=grid(16384), stream=stream0)
        del primals_18
        buf32 = empty_strided_cuda((4, 256, 32, 32), (262144, 1, 8192, 256), torch.float32)
        buf33 = empty_strided_cuda((4, 256, 32, 32), (262144, 1, 8192, 256), torch.int8)
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.max_pool2d_with_indices]
        stream0 = get_raw_stream(0)
        triton_poi_fused_max_pool2d_with_indices_23.run(buf31, buf32, buf33, 1048576, grid=grid(1048576), stream=stream0)
        ...
        assert_size_stride(buf34, (4, 512, 32, 32), (524288, 1, 16384, 512))
        buf35 = buf34; del buf34  # reuse
        # Topologically Sorted Source Nodes: [input_18, input_19], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_24.run(buf35, primals_20, 2097152, grid=grid(2097152), stream=stream0)
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_24.run(buf37, primals_22, 2097152, grid=grid(2097152), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [sub_1, in1_input, input_31, input_32, input_33, input_34, input_35, input_36, input_37, input_38, input_39, input_40, input_41, input_42, input_43, input_44, input_45, input_46, input_47], Original ATen: [aten.sub, aten.div, aten.convolution, aten.relu, aten.max_pool2d_with_indices]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_div_max_pool2d_with_indices_relu_sub_25.run(buf64, buf65, 1048576, grid=grid(1048576), stream=stream0)
        del buf64
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_24.run(buf67, primals_20, 2097152, grid=grid(2097152), stream=stream0)
        del primals_20
        ...
        assert_size_stride(buf68, (4, 512, 32, 32), (524288, 1, 16384, 512))
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_24.run(buf69, primals_22, 2097152, grid=grid(2097152), stream=stream0)
        del primals_22
        ...
        assert_size_stride(buf70, (4, 512, 32, 32), (524288, 1, 16384, 512))
        buf39 = buf38; del buf38  # reuse
        buf91 = empty_strided_cuda((4, 1, 32, 32), (1024, 4096, 32, 1), torch.float32)
        buf92 = reinterpret_tensor(buf91, (4, 1, 32, 32), (1024, 1, 32, 1), 0); del buf91  # reuse
        buf71 = buf70; del buf70  # reuse
        buf94 = buf69; del buf69  # reuse
        buf113 = buf67; del buf67  # reuse
        buf114 = reinterpret_tensor(buf58, (4, 512, 32, 32), (524288, 1, 16384, 512), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [sub_1, in1_input, input_22, input_23, input_31, input_32, input_33, input_34, input_35, input_36, input_37, input_38, input_39, input_40, input_41, input_42, input_43, input_44, input_45, input_46, input_47, input_48, input_49, input_50, input_51, input_52, input_53, pow_10, sum_7, norm_factor_6, add_6, truediv_8, pow_11, sum_8, norm_factor_7, add_7, truediv_9, sub_5, pow_12], Original ATen: [aten.sub, aten.div, aten.convolution, aten.relu, aten.max_pool2d_with_indices, aten.pow, aten.sum, aten.sqrt, aten.add, aten.mul]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_convolution_div_max_pool2d_with_indices_mul_pow_relu_sqrt_sub_sum_26.run(buf39, buf92, buf71, primals_24, buf94, buf113, buf114, 4096, 512, grid=grid(4096), stream=stream0)
        del primals_24
        ...
        assert_size_stride(buf108, (4, 1, 32, 32), (1024, 1, 32, 1))
        buf109 = empty_strided_cuda((4, 1, 1, 1), (1, 4, 4, 4), torch.float32)
        # Topologically Sorted Source Nodes: [mean_3], Original ATen: [aten.mean]
        stream0 = get_raw_stream(0)
        triton_per_fused_mean_27.run(buf108, buf109, 4, 1024, grid=grid(4), stream=stream0)
        del buf108
        ...
        assert_size_stride(buf106, (4, 1, 64, 64), (4096, 1, 64, 1))
        buf107 = empty_strided_cuda((4, 1, 1, 1), (1, 4, 4, 4), torch.float32)
        # Topologically Sorted Source Nodes: [mean_2], Original ATen: [aten.mean]
        stream0 = get_raw_stream(0)
        triton_red_fused_mean_28.run(buf106, buf107, 4, 4096, grid=grid(4), stream=stream0)
        del buf106
        buf10 = empty_strided_cuda((512, 512, 3, 3), (4608, 1, 1536, 512), torch.float32)
        # Unsorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_poi_fused_15.run(primals_25, buf10, 262144, 9, grid=grid(262144, 9), stream=stream0)
        del primals_25
        buf40 = empty_strided_cuda((4, 512, 16, 16), (131072, 1, 8192, 512), torch.float32)
        buf41 = empty_strided_cuda((4, 512, 16, 16), (131072, 1, 8192, 512), torch.int8)
        # Topologically Sorted Source Nodes: [input_24], Original ATen: [aten.max_pool2d_with_indices]
        stream0 = get_raw_stream(0)
        triton_poi_fused_max_pool2d_with_indices_29.run(buf39, buf40, buf41, 524288, grid=grid(524288), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [input_25, input_26], Original ATen: [aten.convolution, aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_30.run(buf43, primals_26, 524288, grid=grid(524288), stream=stream0)
        buf11 = empty_strided_cuda((512, 512, 3, 3), (4608, 1, 1536, 512), torch.float32)
        # Unsorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_poi_fused_15.run(primals_27, buf11, 262144, 9, grid=grid(262144, 9), stream=stream0)
        del primals_27
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_30.run(buf45, primals_28, 524288, grid=grid(524288), stream=stream0)
        buf12 = empty_strided_cuda((512, 512, 3, 3), (4608, 1, 1536, 512), torch.float32)
        # Unsorted Source Nodes: [], Original ATen: []
        stream0 = get_raw_stream(0)
        triton_poi_fused_15.run(primals_29, buf12, 262144, 9, grid=grid(262144, 9), stream=stream0)
        del primals_29
        ...
        buf72 = empty_strided_cuda((4, 512, 16, 16), (131072, 1, 8192, 512), torch.float32)
        # Topologically Sorted Source Nodes: [sub_1, in1_input, input_31, input_32, input_33, input_34, input_35, input_36, input_37, input_38, input_39, input_40, input_41, input_42, input_43, input_44, input_45, input_46, input_47, input_48, input_49, input_50, input_51, input_52, input_53, input_54], Original ATen: [aten.sub, aten.div, aten.convolution, aten.relu, aten.max_pool2d_with_indices]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_div_max_pool2d_with_indices_relu_sub_31.run(buf71, buf72, 524288, grid=grid(524288), stream=stream0)
        del buf71
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_30.run(buf74, primals_26, 524288, grid=grid(524288), stream=stream0)
        del primals_26
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_relu_30.run(buf76, primals_28, 524288, grid=grid(524288), stream=stream0)
        del primals_28
        ...
        assert_size_stride(buf77, (4, 512, 16, 16), (131072, 1, 8192, 512))
        buf47 = buf46; del buf46  # reuse
        buf95 = empty_strided_cuda((4, 1, 16, 16), (256, 1024, 16, 1), torch.float32)
        buf96 = reinterpret_tensor(buf95, (4, 1, 16, 16), (256, 1, 16, 1), 0); del buf95  # reuse
        buf78 = buf77; del buf77  # reuse
        buf97 = empty_strided_cuda((4, 1, 16, 16), (256, 1024, 16, 1), torch.float32)
        buf98 = reinterpret_tensor(buf97, (4, 1, 16, 16), (256, 1, 16, 1), 0); del buf97  # reuse
        buf99 = buf76; del buf76  # reuse
        # Topologically Sorted Source Nodes: [sub_1, in1_input, input_29, input_30, input_31, input_32, input_33, input_34, input_35, input_36, input_37, input_38, input_39, input_40, input_41, input_42, input_43, input_44, input_45, input_46, input_47, input_48, input_49, input_50, input_51, input_52, input_53, input_54, input_55, input_56, input_57, input_58, input_59, input_60, pow_13, sum_9, norm_factor_8, add_8, truediv_10, pow_14, sum_10, norm_factor_9, add_9, truediv_11, sub_6, pow_15], Original ATen: [aten.sub, aten.div, aten.convolution, aten.relu, aten.max_pool2d_with_indices, aten.pow, aten.sum, aten.sqrt, aten.add]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_convolution_div_max_pool2d_with_indices_pow_relu_sqrt_sub_sum_32.run(buf47, buf96, buf78, buf98, primals_30, buf99, 1024, 512, grid=grid(1024), stream=stream0)
        del primals_30
        ...
        assert_size_stride(buf110, (4, 1, 16, 16), (256, 1, 16, 1))
        buf112 = reinterpret_tensor(buf102, (4, 1, 1, 1), (1, 1, 1, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [mean, mean_1, mean_2, mean_3, mean_4, val, val_1, val_2, val_3, val_4], Original ATen: [aten.mean, aten.add]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_mean_33.run(buf112, buf110, buf105, buf107, buf109, 4, 256, grid=grid(4), stream=stream0)
        del buf105
        del buf107
        del buf109
        del buf110
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_4 = rand_strided((4, 3, 256, 256), (196608, 65536, 256, 1), device='cuda:0', dtype=torch.float32)
