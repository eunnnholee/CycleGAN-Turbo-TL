...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, primals_9, primals_10, primals_11, primals_12, primals_13, primals_14, primals_15, primals_16, primals_17, primals_18, primals_19, primals_20, primals_21, primals_22, primals_23, primals_24, primals_25, primals_26, primals_27, primals_28, primals_29, primals_30, primals_31, primals_32, primals_33, primals_34, primals_35, primals_36, primals_37, primals_38, primals_39, primals_40, primals_41, primals_42, primals_43, primals_44, primals_45, primals_46, primals_47, primals_48, primals_49, primals_50, primals_51, primals_52, primals_53, primals_54, primals_55, primals_56, primals_57, primals_58, primals_59, primals_60, primals_61, primals_62, primals_63, primals_64, primals_65, primals_66, primals_67, primals_68, primals_69, primals_70, primals_71, primals_72, primals_73, primals_74, primals_75, primals_76, primals_77, primals_78, primals_79, primals_80, primals_81, primals_82, primals_83, primals_84, primals_85, primals_86, primals_87, primals_88, primals_89, primals_90, primals_91, primals_92, primals_93, primals_94, primals_95, primals_96, primals_97, primals_98, primals_99, primals_100, primals_101, primals_102, primals_103, primals_104, primals_105, primals_106, primals_107, primals_108, primals_109, primals_110, primals_111, primals_112, primals_113, primals_114, primals_115, primals_116, primals_117, primals_118, primals_119, primals_120, primals_121, primals_122, primals_123, primals_124, primals_125, primals_126, primals_127, primals_128, primals_129, primals_130, primals_131, primals_132, primals_133, primals_134, primals_135, primals_136, primals_137, primals_138, primals_139, primals_140, primals_141, primals_142, primals_143, primals_144, primals_145, primals_146, primals_147, primals_148, primals_149, primals_150, primals_151, primals_152, primals_153, primals_154, primals_155, primals_156, primals_157, primals_158, primals_159, primals_160, primals_161, primals_162, primals_163, primals_164, primals_165, primals_166, primals_167, primals_168, primals_169, primals_170, primals_171, primals_172, primals_173, primals_174, primals_175, primals_176, primals_177, primals_178, primals_179, primals_180, primals_181):
        ...
        index = torch.ops.aten.index.Tensor(clone, [expand, clamp_max, clamp_max_1]);  clone = expand = clamp_max = clamp_max_1 = None
        ...
        expand_3 = torch.ops.aten.expand.default(view, [2, 128, 128]);  view = None
        ...
        _adaptive_avg_pool2d = torch.ops.aten._adaptive_avg_pool2d.default(add_10, [224, 224]);  add_10 = None
        ...
        div = torch.ops.aten.div.Tensor(sub_5, device_put_1);  sub_5 = device_put_1 = None
        convolution = torch.ops.aten.convolution.default(div, primals_4, None, [32, 32], [0, 0], [1, 1], False, [0, 0], 1);  div = primals_4 = None
        ...
        mul_5 = torch.ops.aten.mul.Tensor(sub_6, rsqrt);  sub_6 = rsqrt = None
        mul_6 = torch.ops.aten.mul.Tensor(mul_5, primals_7);  mul_5 = primals_7 = None
        ...
        mul_7 = torch.ops.aten.mul.Tensor(sub_7, rsqrt_1);  sub_7 = rsqrt_1 = None
        mul_8 = torch.ops.aten.mul.Tensor(mul_7, primals_9);  mul_7 = primals_9 = None
        ...
        addmm = torch.ops.aten.addmm.default(primals_11, view_7, permute_4);  primals_11 = view_7 = permute_4 = None
        ...
        permute_9 = torch.ops.aten.permute.default(getitem_4, [2, 0, 1, 3]);  getitem_4 = None
        ...
        addmm_1 = torch.ops.aten.addmm.default(primals_14, view_16, permute_10);  primals_14 = view_16 = permute_10 = None
        ...
        mul_9 = torch.ops.aten.mul.Tensor(sub_8, rsqrt_2);  sub_8 = rsqrt_2 = None
        mul_10 = torch.ops.aten.mul.Tensor(mul_9, primals_15);  mul_9 = primals_15 = None
        ...
        addmm_2 = torch.ops.aten.addmm.default(primals_18, view_18, permute_11);  primals_18 = view_18 = permute_11 = None
        ...
        addmm_3 = torch.ops.aten.addmm.default(primals_20, view_20, permute_12);  primals_20 = view_20 = permute_12 = None
        ...
        mul_13 = torch.ops.aten.mul.Tensor(sub_9, rsqrt_3);  sub_9 = rsqrt_3 = None
        mul_14 = torch.ops.aten.mul.Tensor(mul_13, primals_21);  mul_13 = primals_21 = None
        ...
        addmm_4 = torch.ops.aten.addmm.default(primals_23, view_22, permute_13);  primals_23 = view_22 = permute_13 = None
        ...
        permute_18 = torch.ops.aten.permute.default(getitem_12, [2, 0, 1, 3]);  getitem_12 = None
        ...
        addmm_5 = torch.ops.aten.addmm.default(primals_26, view_31, permute_19);  primals_26 = view_31 = permute_19 = None
        ...
        mul_15 = torch.ops.aten.mul.Tensor(sub_10, rsqrt_4);  sub_10 = rsqrt_4 = None
        mul_16 = torch.ops.aten.mul.Tensor(mul_15, primals_27);  mul_15 = primals_27 = None
        ...
        addmm_6 = torch.ops.aten.addmm.default(primals_30, view_33, permute_20);  primals_30 = view_33 = permute_20 = None
        ...
        addmm_7 = torch.ops.aten.addmm.default(primals_32, view_35, permute_21);  primals_32 = view_35 = permute_21 = None
        ...
        mul_19 = torch.ops.aten.mul.Tensor(sub_11, rsqrt_5);  sub_11 = rsqrt_5 = None
        mul_20 = torch.ops.aten.mul.Tensor(mul_19, primals_33);  mul_19 = primals_33 = None
        ...
        addmm_8 = torch.ops.aten.addmm.default(primals_35, view_37, permute_22);  primals_35 = view_37 = permute_22 = None
        ...
        permute_27 = torch.ops.aten.permute.default(getitem_20, [2, 0, 1, 3]);  getitem_20 = None
        ...
        addmm_9 = torch.ops.aten.addmm.default(primals_38, view_46, permute_28);  primals_38 = view_46 = permute_28 = None
        ...
        mul_21 = torch.ops.aten.mul.Tensor(sub_12, rsqrt_6);  sub_12 = rsqrt_6 = None
        mul_22 = torch.ops.aten.mul.Tensor(mul_21, primals_39);  mul_21 = primals_39 = None
        ...
        addmm_10 = torch.ops.aten.addmm.default(primals_42, view_48, permute_29);  primals_42 = view_48 = permute_29 = None
        ...
        addmm_11 = torch.ops.aten.addmm.default(primals_44, view_50, permute_30);  primals_44 = view_50 = permute_30 = None
        ...
        mul_25 = torch.ops.aten.mul.Tensor(sub_13, rsqrt_7);  sub_13 = rsqrt_7 = None
        mul_26 = torch.ops.aten.mul.Tensor(mul_25, primals_45);  mul_25 = primals_45 = None
        ...
        addmm_12 = torch.ops.aten.addmm.default(primals_47, view_52, permute_31);  primals_47 = view_52 = permute_31 = None
        ...
        permute_36 = torch.ops.aten.permute.default(getitem_28, [2, 0, 1, 3]);  getitem_28 = None
        ...
        addmm_13 = torch.ops.aten.addmm.default(primals_50, view_61, permute_37);  primals_50 = view_61 = permute_37 = None
        ...
        mul_27 = torch.ops.aten.mul.Tensor(sub_14, rsqrt_8);  sub_14 = rsqrt_8 = None
        mul_28 = torch.ops.aten.mul.Tensor(mul_27, primals_51);  mul_27 = primals_51 = None
        ...
        addmm_14 = torch.ops.aten.addmm.default(primals_54, view_63, permute_38);  primals_54 = view_63 = permute_38 = None
        ...
        addmm_15 = torch.ops.aten.addmm.default(primals_56, view_65, permute_39);  primals_56 = view_65 = permute_39 = None
        ...
        mul_32 = torch.ops.aten.mul.Tensor(mul_31, primals_57);  mul_31 = primals_57 = None
        ...
        addmm_16 = torch.ops.aten.addmm.default(primals_59, view_67, permute_41);  primals_59 = view_67 = permute_41 = None
        ...
        permute_46 = torch.ops.aten.permute.default(getitem_36, [2, 0, 1, 3]);  getitem_36 = None
        ...
        addmm_17 = torch.ops.aten.addmm.default(primals_62, view_76, permute_47);  primals_62 = view_76 = permute_47 = None
        view_77 = torch.ops.aten.view.default(addmm_17, [50, 2, 768]);  addmm_17 = None
        add_41 = torch.ops.aten.add.Tensor(add_38, view_77);  add_38 = view_77 = None
        ...
        mul_33 = torch.ops.aten.mul.Tensor(sub_16, rsqrt_10);  sub_16 = rsqrt_10 = None
        mul_34 = torch.ops.aten.mul.Tensor(mul_33, primals_63);  mul_33 = primals_63 = None
        ...
        addmm_18 = torch.ops.aten.addmm.default(primals_66, view_78, permute_48);  primals_66 = view_78 = permute_48 = None
        ...
        addmm_19 = torch.ops.aten.addmm.default(primals_68, view_80, permute_49);  primals_68 = view_80 = permute_49 = None
        ...
        mul_37 = torch.ops.aten.mul.Tensor(sub_17, rsqrt_11);  sub_17 = rsqrt_11 = None
        mul_38 = torch.ops.aten.mul.Tensor(mul_37, primals_69);  mul_37 = primals_69 = None
        ...
        addmm_20 = torch.ops.aten.addmm.default(primals_71, view_82, permute_50);  primals_71 = view_82 = permute_50 = None
        ...
        permute_55 = torch.ops.aten.permute.default(getitem_44, [2, 0, 1, 3]);  getitem_44 = None
        ...
        addmm_21 = torch.ops.aten.addmm.default(primals_74, view_91, permute_56);  primals_74 = view_91 = permute_56 = None
        ...
        mul_39 = torch.ops.aten.mul.Tensor(sub_18, rsqrt_12);  sub_18 = rsqrt_12 = None
        mul_40 = torch.ops.aten.mul.Tensor(mul_39, primals_75);  mul_39 = primals_75 = None
        ...
        addmm_22 = torch.ops.aten.addmm.default(primals_78, view_93, permute_57);  primals_78 = view_93 = permute_57 = None
        ...
        addmm_23 = torch.ops.aten.addmm.default(primals_80, view_95, permute_58);  primals_80 = view_95 = permute_58 = None
        ...
        mul_43 = torch.ops.aten.mul.Tensor(sub_19, rsqrt_13);  sub_19 = rsqrt_13 = None
        mul_44 = torch.ops.aten.mul.Tensor(mul_43, primals_81);  mul_43 = primals_81 = None
        ...
        addmm_24 = torch.ops.aten.addmm.default(primals_83, view_97, permute_59);  primals_83 = view_97 = permute_59 = None
        ...
        permute_64 = torch.ops.aten.permute.default(getitem_52, [2, 0, 1, 3]);  getitem_52 = None
        ...
        addmm_25 = torch.ops.aten.addmm.default(primals_86, view_106, permute_65);  primals_86 = view_106 = permute_65 = None
        ...
        mul_45 = torch.ops.aten.mul.Tensor(sub_20, rsqrt_14);  sub_20 = rsqrt_14 = None
        mul_46 = torch.ops.aten.mul.Tensor(mul_45, primals_87);  mul_45 = primals_87 = None
        ...
        addmm_26 = torch.ops.aten.addmm.default(primals_90, view_108, permute_66);  primals_90 = view_108 = permute_66 = None
        ...
        addmm_27 = torch.ops.aten.addmm.default(primals_92, view_110, permute_67);  primals_92 = view_110 = permute_67 = None
        ...
        mul_49 = torch.ops.aten.mul.Tensor(sub_21, rsqrt_15);  sub_21 = rsqrt_15 = None
        mul_50 = torch.ops.aten.mul.Tensor(mul_49, primals_93);  mul_49 = primals_93 = None
        ...
        addmm_28 = torch.ops.aten.addmm.default(primals_95, view_112, permute_68);  primals_95 = view_112 = permute_68 = None
        ...
        permute_73 = torch.ops.aten.permute.default(getitem_60, [2, 0, 1, 3]);  getitem_60 = None
        ...
        addmm_29 = torch.ops.aten.addmm.default(primals_98, view_121, permute_74);  primals_98 = view_121 = permute_74 = None
        ...
        mul_51 = torch.ops.aten.mul.Tensor(sub_22, rsqrt_16);  sub_22 = rsqrt_16 = None
        mul_52 = torch.ops.aten.mul.Tensor(mul_51, primals_99);  mul_51 = primals_99 = None
        ...
        addmm_30 = torch.ops.aten.addmm.default(primals_102, view_123, permute_75);  primals_102 = view_123 = permute_75 = None
        ...
        addmm_31 = torch.ops.aten.addmm.default(primals_104, view_125, permute_76);  primals_104 = view_125 = permute_76 = None
        ...
        mul_55 = torch.ops.aten.mul.Tensor(sub_23, rsqrt_17);  sub_23 = rsqrt_17 = None
        mul_56 = torch.ops.aten.mul.Tensor(mul_55, primals_105);  mul_55 = primals_105 = None
        ...
        addmm_32 = torch.ops.aten.addmm.default(primals_107, view_127, permute_78);  primals_107 = view_127 = permute_78 = None
        ...
        permute_83 = torch.ops.aten.permute.default(getitem_68, [2, 0, 1, 3]);  getitem_68 = None
        ...
        addmm_33 = torch.ops.aten.addmm.default(primals_110, view_136, permute_84);  primals_110 = view_136 = permute_84 = None
        view_137 = torch.ops.aten.view.default(addmm_33, [50, 2, 768]);  addmm_33 = None
        add_65 = torch.ops.aten.add.Tensor(add_62, view_137);  add_62 = view_137 = None
        ...
        mul_57 = torch.ops.aten.mul.Tensor(sub_24, rsqrt_18);  sub_24 = rsqrt_18 = None
        mul_58 = torch.ops.aten.mul.Tensor(mul_57, primals_111);  mul_57 = primals_111 = None
        ...
        addmm_34 = torch.ops.aten.addmm.default(primals_114, view_138, permute_85);  primals_114 = view_138 = permute_85 = None
        ...
        addmm_35 = torch.ops.aten.addmm.default(primals_116, view_140, permute_86);  primals_116 = view_140 = permute_86 = None
        ...
        mul_61 = torch.ops.aten.mul.Tensor(sub_25, rsqrt_19);  sub_25 = rsqrt_19 = None
        mul_62 = torch.ops.aten.mul.Tensor(mul_61, primals_117);  mul_61 = primals_117 = None
        ...
        addmm_36 = torch.ops.aten.addmm.default(primals_119, view_142, permute_87);  primals_119 = view_142 = permute_87 = None
        ...
        permute_92 = torch.ops.aten.permute.default(getitem_76, [2, 0, 1, 3]);  getitem_76 = None
        ...
        addmm_37 = torch.ops.aten.addmm.default(primals_122, view_151, permute_93);  primals_122 = view_151 = permute_93 = None
        ...
        mul_63 = torch.ops.aten.mul.Tensor(sub_26, rsqrt_20);  sub_26 = rsqrt_20 = None
        mul_64 = torch.ops.aten.mul.Tensor(mul_63, primals_123);  mul_63 = primals_123 = None
        ...
        addmm_38 = torch.ops.aten.addmm.default(primals_126, view_153, permute_94);  primals_126 = view_153 = permute_94 = None
        ...
        addmm_39 = torch.ops.aten.addmm.default(primals_128, view_155, permute_95);  primals_128 = view_155 = permute_95 = None
        ...
        mul_67 = torch.ops.aten.mul.Tensor(sub_27, rsqrt_21);  sub_27 = rsqrt_21 = None
        mul_68 = torch.ops.aten.mul.Tensor(mul_67, primals_129);  mul_67 = primals_129 = None
        ...
        addmm_40 = torch.ops.aten.addmm.default(primals_131, view_157, permute_96);  primals_131 = view_157 = permute_96 = None
        ...
        permute_101 = torch.ops.aten.permute.default(getitem_84, [2, 0, 1, 3]);  getitem_84 = None
        ...
        addmm_41 = torch.ops.aten.addmm.default(primals_134, view_166, permute_102);  primals_134 = view_166 = permute_102 = None
        ...
        mul_69 = torch.ops.aten.mul.Tensor(sub_28, rsqrt_22);  sub_28 = rsqrt_22 = None
        mul_70 = torch.ops.aten.mul.Tensor(mul_69, primals_135);  mul_69 = primals_135 = None
        ...
        addmm_42 = torch.ops.aten.addmm.default(primals_138, view_168, permute_103);  primals_138 = view_168 = permute_103 = None
        ...
        addmm_43 = torch.ops.aten.addmm.default(primals_140, view_170, permute_104);  primals_140 = view_170 = permute_104 = None
        ...
        mul_73 = torch.ops.aten.mul.Tensor(sub_29, rsqrt_23);  sub_29 = rsqrt_23 = None
        mul_74 = torch.ops.aten.mul.Tensor(mul_73, primals_141);  mul_73 = primals_141 = None
        ...
        addmm_44 = torch.ops.aten.addmm.default(primals_143, view_172, permute_105);  primals_143 = view_172 = permute_105 = None
        ...
        permute_110 = torch.ops.aten.permute.default(getitem_92, [2, 0, 1, 3]);  getitem_92 = None
        ...
        addmm_45 = torch.ops.aten.addmm.default(primals_146, view_181, permute_111);  primals_146 = view_181 = permute_111 = None
        ...
        mul_75 = torch.ops.aten.mul.Tensor(sub_30, rsqrt_24);  sub_30 = rsqrt_24 = None
        mul_76 = torch.ops.aten.mul.Tensor(mul_75, primals_147);  mul_75 = primals_147 = None
        ...
        addmm_46 = torch.ops.aten.addmm.default(primals_150, view_183, permute_112);  primals_150 = view_183 = permute_112 = None
        ...
        addmm_47 = torch.ops.aten.addmm.default(primals_152, view_185, permute_113);  primals_152 = view_185 = permute_113 = None
        ...
        mul_79 = torch.ops.aten.mul.Tensor(sub_31, rsqrt_25);  sub_31 = rsqrt_25 = None
        mul_80 = torch.ops.aten.mul.Tensor(mul_79, primals_153);  mul_79 = primals_153 = None
        add_88 = torch.ops.aten.add.Tensor(mul_80, primals_154);  mul_80 = primals_154 = None
        mm = torch.ops.aten.mm.default(add_88, primals_155);  add_88 = primals_155 = None
        ...
        convolution_1 = torch.ops.aten.convolution.default(view_187, div_3, primals_159, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  primals_159 = None
        ...
        convolution_4 = torch.ops.aten.convolution.default(view_188, div_9, primals_168, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  primals_168 = None
        ...
        addmm_48 = torch.ops.aten.addmm.default(primals_177, mm, permute_122);  primals_177 = permute_122 = None
        ...
        abs_1 = torch.ops.aten.abs.default(squeeze_12)
        ...
        sub_34 = torch.ops.aten.sub.Tensor(squeeze_12, sub_33);  squeeze_12 = sub_33 = None
        ...
        abs_2 = torch.ops.aten.abs.default(squeeze_13)
        ...
        sub_37 = torch.ops.aten.sub.Tensor(squeeze_13, sub_36);  squeeze_13 = sub_36 = None
        ...
        sub_40 = torch.ops.aten.sub.Tensor(addmm_49, sub_39);  sub_39 = None
