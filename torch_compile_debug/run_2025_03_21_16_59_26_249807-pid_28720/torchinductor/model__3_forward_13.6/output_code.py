...
# kernel path: /tmp/torchinductor_elicer/5a/c5adu3d7lgghh6cetpnajzliouklu42f2iowzcksfbictnzi7mmk.py
...
#   loss => add_89
#   loss_ => abs_1, exp, full_default_5, log1p, minimum, neg, sub_33, sub_34
#   loss_1 => add_90
#   loss_2 => add_91
#   loss_3 => add_92
#   loss__2 => abs_2, exp_1, log1p_1, minimum_1, neg_1, sub_36, sub_37
#   loss__4 => abs_3, exp_2, log1p_2, minimum_2, neg_2, sub_39, sub_40
#   mean_2 => mean_2
#   mean_3 => mean_3
# Graph fragment:
#   %convolution_3 : [num_users=2] = call_function[target=torch.ops.aten.convolution.default](args = (%convolution_2, %div_6, %primals_164, [2, 2], [0, 0], [1, 1], False, [0, 0], 1), kwargs = {})
...
#   %sub_34 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%squeeze_12, %sub_33), kwargs = {})
...
#   %sub_37 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%squeeze_13, %sub_36), kwargs = {})
...
#   %sub_40 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%addmm_49, %sub_39), kwargs = {})
...
def triton_per_fused_add_binary_cross_entropy_with_logits_convolution_mean_38(in_out_ptr0, in_out_ptr1, in_out_ptr2, in_ptr0, in_ptr1, in_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp2 = tl.broadcast_to(tmp1, [XBLOCK, RBLOCK])
    tmp16 = tl.load(in_out_ptr1 + (r1 + 9*x0), rmask & xmask, other=0.0)
    tmp17 = tl.load(in_ptr1 + (0))
    tmp18 = tl.broadcast_to(tmp17, [XBLOCK, RBLOCK])
    tmp36 = tl.load(in_ptr2 + (x0), xmask, eviction_policy='evict_last')
    tmp3 = tmp0 + tmp2
    tmp4 = 0.0
    tmp5 = triton_helpers.minimum(tmp4, tmp3)
    tmp6 = tl_math.abs(tmp3)
    tmp7 = -tmp6
    ...
    tmp19 = tmp16 + tmp18
    tmp20 = triton_helpers.minimum(tmp4, tmp19)
    ...
    tmp34 = tmp30 / tmp31
    tmp35 = tmp33 + tmp34
    tmp37 = triton_helpers.minimum(tmp4, tmp36)
    ...
    tl.store(in_out_ptr1 + (r1 + 9*x0), tmp19, rmask & xmask)
    tl.debug_barrier()
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [loss__4], Original ATen: [aten.binary_cross_entropy_with_logits]
