...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_156, primals_160, primals_161, primals_162, primals_165, primals_169, primals_170, primals_171, primals_174, primals_178, primals_179, mm, view_187, view_188, div_1, div_2, sum_6, div_3, constant_pad_nd_1, convolution_2, clamp_min_6, sum_9, div_6, convolution_3, div_7, div_8, sum_18, div_9, constant_pad_nd_2, convolution_5, clamp_min_10, sum_21, div_12, convolution_6, div_13, div_14, sum_30, where_2, clamp_min_14, sum_33, addmm_49, permute_125, gt_4, gt_5, tangents_1, tangents_2, tangents_3, tangents_4, tangents_5, tangents_6, tangents_7):
        ...
        mul_111 = torch.ops.aten.mul.Tensor(sigmoid_12, tangents_1);  sigmoid_12 = None
        ...
        mul_112 = torch.ops.aten.mul.Tensor(sigmoid_13, div_19);  sigmoid_13 = None
        ...
        mul_113 = torch.ops.aten.mul.Tensor(sigmoid_14, div_19);  sigmoid_14 = div_19 = None
        mm_1 = torch.ops.aten.mm.default(mul_111, permute_125);  permute_125 = None
        permute_126 = torch.ops.aten.permute.default(mul_111, [1, 0])
        mm_2 = torch.ops.aten.mm.default(permute_126, where_2);  permute_126 = None
        sum_37 = torch.ops.aten.sum.dim_IntList(mul_111, [0], True);  mul_111 = None
        ...
        mul_114 = torch.ops.aten.mul.Tensor(neg_3, div_22);  neg_3 = div_22 = None
        div_23 = torch.ops.aten.div.Tensor(add_93, sum_36);  add_93 = sum_36 = None
        sum_38 = torch.ops.aten.sum.default(mul_114);  mul_114 = None
        mul_115 = torch.ops.aten.mul.Tensor(sum_38, div_17);  sum_38 = None
        view_200 = torch.ops.aten.view.default(mul_115, [1, 1]);  mul_115 = None
        ...
        mul_116 = torch.ops.aten.mul.Tensor(view_200, div_16);  view_200 = div_16 = None
        add_94 = torch.ops.aten.add.Tensor(div_23, mul_116);  div_23 = mul_116 = None
        gt_3 = torch.ops.aten.gt.Scalar(where_2, 0);  where_2 = None
        mul_117 = torch.ops.aten.mul.Tensor(mm_1, 0.2)
        where_3 = torch.ops.aten.where.self(gt_3, mm_1, mul_117);  gt_3 = mm_1 = mul_117 = None
        ...
        mul_118 = torch.ops.aten.mul.Tensor(neg_4, div_25);  neg_4 = div_25 = None
        div_26 = torch.ops.aten.div.Tensor(add_95, sum_30);  add_95 = sum_30 = None
        sum_40 = torch.ops.aten.sum.default(mul_118);  mul_118 = None
        mul_119 = torch.ops.aten.mul.Tensor(sum_40, div_14);  sum_40 = div_14 = None
        view_203 = torch.ops.aten.view.default(mul_119, [256, 1]);  mul_119 = None
        mul_120 = torch.ops.aten.mul.Tensor(view_203, div_13);  view_203 = div_13 = None
        add_96 = torch.ops.aten.add.Tensor(div_26, mul_120);  div_26 = mul_120 = None
        unsqueeze_22 = torch.ops.aten.unsqueeze.default(mul_112, 1);  mul_112 = None
        ...
        mul_121 = torch.ops.aten.mul.Tensor(neg_5, div_28);  neg_5 = div_28 = None
        div_29 = torch.ops.aten.div.Tensor(add_97, sum_24);  add_97 = sum_24 = None
        sum_42 = torch.ops.aten.sum.default(mul_121);  mul_121 = None
        mul_122 = torch.ops.aten.mul.Tensor(sum_42, div_11);  sum_42 = None
        view_205 = torch.ops.aten.view.default(mul_122, [1, 1]);  mul_122 = None
        ...
        mul_123 = torch.ops.aten.mul.Tensor(view_205, div_10);  view_205 = div_10 = None
        view_206 = torch.ops.aten.view.default(mul_123, [1, 256, 1, 1]);  mul_123 = None
        ...
        mul_124 = torch.ops.aten.mul.Tensor(constant_pad_nd_3, 0.2)
        where_4 = torch.ops.aten.where.self(gt_4, constant_pad_nd_3, mul_124);  gt_4 = constant_pad_nd_3 = mul_124 = None
        ...
        mul_125 = torch.ops.aten.mul.Tensor(neg_6, div_31);  neg_6 = div_31 = None
        div_32 = torch.ops.aten.div.Tensor(add_99, sum_18);  add_99 = sum_18 = None
        sum_44 = torch.ops.aten.sum.default(mul_125);  mul_125 = None
        mul_126 = torch.ops.aten.mul.Tensor(sum_44, div_8);  sum_44 = div_8 = None
        view_207 = torch.ops.aten.view.default(mul_126, [256, 1]);  mul_126 = None
        mul_127 = torch.ops.aten.mul.Tensor(view_207, div_7);  view_207 = div_7 = None
        view_208 = torch.ops.aten.view.default(mul_127, [256, 768, 3, 3]);  mul_127 = None
        add_100 = torch.ops.aten.add.Tensor(div_32, view_208);  div_32 = view_208 = None
        unsqueeze_23 = torch.ops.aten.unsqueeze.default(mul_113, 1);  mul_113 = None
        ...
        mul_128 = torch.ops.aten.mul.Tensor(neg_7, div_34);  neg_7 = div_34 = None
        div_35 = torch.ops.aten.div.Tensor(add_101, sum_12);  add_101 = sum_12 = None
        sum_46 = torch.ops.aten.sum.default(mul_128);  mul_128 = None
        mul_129 = torch.ops.aten.mul.Tensor(sum_46, div_5);  sum_46 = None
        view_209 = torch.ops.aten.view.default(mul_129, [1, 1]);  mul_129 = None
        ...
        mul_130 = torch.ops.aten.mul.Tensor(view_209, div_4);  view_209 = div_4 = None
        view_210 = torch.ops.aten.view.default(mul_130, [1, 256, 1, 1]);  mul_130 = None
        ...
        mul_131 = torch.ops.aten.mul.Tensor(constant_pad_nd_4, 0.2)
        where_5 = torch.ops.aten.where.self(gt_5, constant_pad_nd_4, mul_131);  gt_5 = constant_pad_nd_4 = mul_131 = None
        ...
        mul_132 = torch.ops.aten.mul.Tensor(neg_8, div_37);  neg_8 = div_37 = None
        div_38 = torch.ops.aten.div.Tensor(add_103, sum_6);  add_103 = sum_6 = None
        sum_48 = torch.ops.aten.sum.default(mul_132);  mul_132 = None
        mul_133 = torch.ops.aten.mul.Tensor(sum_48, div_2);  sum_48 = div_2 = None
        view_211 = torch.ops.aten.view.default(mul_133, [256, 1]);  mul_133 = None
        mul_134 = torch.ops.aten.mul.Tensor(view_211, div_1);  view_211 = div_1 = None
        view_212 = torch.ops.aten.view.default(mul_134, [256, 768, 3, 3]);  mul_134 = None
